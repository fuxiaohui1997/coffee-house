    ...
    <van-row class="goods"
      ...
      <div>
        ...
        <div v-if="!lists.length">
          <van-button style="background-color:transparent;border:none;"
                      type="default">空空如也，去逛逛！</van-button>
          <!-- 推荐 -->
        ...
        <div v-for="(item,index) in lists"
          ...
          <van-card :price="item.price"
            ...
            <div slot="footer">
              <van-checkbox class="checkboxbutton"
                            v-model="item.isSelect"></van-checkbox>
